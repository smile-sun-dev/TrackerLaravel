                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-striped table-valign-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{++$key}}</td>
                                        <td>{{env('APP_SHORT_CODE') . $booking->id}} @if(date('Y-m-d' , strtotime($booking->booking_date)) == date('Y-m-d'))
                                        ...
                                        <button type="button" class="btn btn-default view-booking"
                                               data-booking="{{env('APP_SHORT_CODE')}}{{$booking->id}}" data-name="{{$booking->types->name}}" data-vehicle="{{$booking->get_vehicle->vehicle_class}}" data-miles="{{$booking->miles}}" data-bill_amount="{{$booking->bill_amount}}">
