                    ...
                    <div class="row">
                        ...
                        <div class="top-btn-row">
                                    ...
                                    <div class="project-summry">
                                        ...
                                        <div class="room-summry">
                                            ...
                                            <tr class="head6"><td colspan="2"><i class="fas fa-grip-vertical"></i>Kitchen</td></tr>
                                                ...
                                                <tr>
                                                    <td><a data-bs-toggle="modal" href="#addunitmodal" role="button" class="add selected"><i class="fas fa-plus"></i></a></td>
                                                    <td><a data-bs-toggle="modal" href="#addunitmodal" role="button" class="add"><i class="fas fa-plus"></i></a></td>
                                                </tr>
                                                <tr>
                                                    <td><a data-bs-toggle="modal" href="#addunitmodal" role="button" class="add"><i class="fas fa-plus"></i></a></td>
                                                    <td><a data-bs-toggle="modal" href="#addunitmodal" role="button" class="add"><i class="fas fa-plus"></i></a></td>
                            ...
                            <div class="btn-row">
                                ...
                                <a href="/countrywide-stone/project-step3.php" class="btn btn-primary common-btn">Next</a>
                            </div>
                            </div>
                        </div>
                        <div class="col-md-3">  
